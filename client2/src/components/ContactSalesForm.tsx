                        ...
                        >
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', marginBottom: 26, borderTop: `1px solid ${BORDER}`, borderBottom: `1px solid ${BORDER}` }}>
                                {[
                                    ...
                                    { value: 'Kolkata, India', href: null, icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg> },
                                ].map((opt, i) => {
                                    const inner = (
                                        <>
